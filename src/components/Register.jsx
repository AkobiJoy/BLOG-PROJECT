...
import { GoEyeClosed } from "react-icons/go"; 4
          ...
          <form onSubmit={submitHandler} className="flex flex-col gap-3">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-3 outline-sky-100 border-3 rounded border-white placeholder-gray-400 ${nameErr ? "placeholder-red-600 italic border-2 border-red-500" : ""
                  }`}
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-3 outline-sky-100 border-3 rounded border-white placeholder-gray-400 ${lastNameErr ? "placeholder-red-600 italic border-2 border-red-500" : ""
                  }`}
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-3 outline-sky-100 border-3 rounded border-white placeholder-gray-400 ${emailErr ? "placeholder-red-600 border-2 italic border-red-500" : ""
                  }`}
              />
            </div>
            ...
            <div className="relative w-full">
              ...
              <select
                ...
                value={gender}
                className={`w-full h-[3.2rem] px-3 py-2 text-gray-700 bg-white border rounded-md outline-none focus:border-sky-100 focus:ring-2 focus:ring-sky-100 ${genderErr ? "border-red-500 ring-red-200" : "border-gray-300"
                  }`}
              >
            ...
            <div className="relative mb-5">
              ...
              <input
                ...
                className={`w-full px-3 py-3 outline-sky-100 border-3 rounded border-white placeholder-gray-400 ${passwordErr ? "placeholder-red-600 border-2 italic border-red-500" : ""
                  }`}
              />
              <div
                onClick={toggleShow}
